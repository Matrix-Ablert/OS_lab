...
public:
    ...
    bool readSectorsOptimized(uint32 lba, uint32 count, void *buffer);
    bool writeSectorsOptimized(uint32 lba, uint32 count, const void *buffer);
    void resetCounters();
    uint32 getCommandCount();
    uint32 getWordIOCount();
